...
open class FnafUBlockDecorItem(rawID: String, block: CustomBlockType, val translation: TranslatableThing) : FnafUBlockItem(rawID, block) {
    ...
    override fun getTranslations(): TranslatableThing? = translation
