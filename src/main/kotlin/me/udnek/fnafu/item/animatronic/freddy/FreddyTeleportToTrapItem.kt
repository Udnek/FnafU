...
class FreddyTeleportToTrapItem : ConstructableCustomItem() {
    override fun initializeComponents() {
        super.initializeComponents()
        components.set(AbilityIconFilesComponent(Kit.FREDDY))
        components.getOrCreateDefault(RPGUComponents.ACTIVE_ABILITY_ITEM).components.set(FnafUComponents.FREDDY_TELEPORT_TO_TRAP_ABILITY.createNewDefault())
    }
